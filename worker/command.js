...
sock.sendMessage(from, { caption: listmn, location: { jpegThumbnail: fs.readFileSync('./worker/media/image/loc.jpg') }, buttons: but, footer: '©Rain Betmut🍭'})
}
break
break
case prefix+'gura':
...
hydratedFooterText: "© Rain Betmut🍭",
hydratedButtons: [{
urlButton: {
displayText: 'Group Whatsapp',
url: linkgrupss
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© Rain Betmut🍭", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© Rain Betmut🍭", log0, btn, thum)
}
...
title:"ɴᴇᴢᴜᴋᴏ ʙᴏᴛ-ᴍᴅ✿ Qris ( Donate )",
body: "©RAIN", 
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"ɴᴇᴢᴜᴋᴏ ʙᴏᴛ-ᴍᴅ✿ By Rain Betmut🍭",
body:"© ɴᴇᴢᴜᴋᴏ ʙᴏᴛ-ᴍᴅ✿",
thumbnail: log0,
mediaType:2,
...
sock.sendMessage("6282274499424@s.whatsapp.net", util.format(err), {quoted:m})
console.log(err)
}
}
